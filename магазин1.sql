...
CREATE TABLE IF NOT EXISTS `mydb`.`Сотрудники` (
  ...
  INDEX `fk_Сотрудники_магазин_idx` (`магазин_id_адреса магазинов` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Каталог` (
  ...
  INDEX `fk_Каталог_магазин1_idx` (`магазин_id_адреса магазинов` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Поставщики` (
  ...
  INDEX `fk_Поставщики_магазин1_idx` (`магазин_id_адреса магазинов` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`акции` (
  ...
  INDEX `fk_акции_Сотрудники1_idx` (`Сотрудники_id_сотрудника` ASC),
  INDEX `fk_акции_Каталог1_idx` (`Каталог_id_товара` ASC),
